...
QRCode.prototype = {
  ...
  make: function () {
    ...
    this.setupTypeInfo(0, true)
    if (this.typeNumber >= 7) {
      this.setupTypeNumber(true)
    }

    // Add data codewords
    this.setupData(this.dataCache)
    ...
    // Replace type info bits with correct values
  ...
  setupTypeNumber: function (test) {
    var bits = Version.getEncodedBits(this.typeNumber)
    var row, col, mod
  ...
  setupTypeInfo: function (maskPattern, test) {
    var bits = FormatInfo.getEncodedBits(this.errorCorrectLevel, maskPattern)
    var i, mod
