...
var QRCodeLib = require('./core/qrcode.js')
...
QRCodeDraw.prototype = {
  ...
  drawBitArray: function (/* text, errorCorrectLevel,options,cb */) {
    ...
    var level, error, errorCorrectLevel
  ...
  QRVersion: function (text, ecl, version, cb) {
    var c = Buffer.byteLength(text, 'utf8')
    var error
    var errorCorrectLevel = this.QRErrorCorrectLevel[ecl]
